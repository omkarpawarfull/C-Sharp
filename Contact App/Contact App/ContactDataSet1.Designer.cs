...
namespace Contact_App {
    ...
    public partial class ContactDataSet1 : global::System.Data.DataSet {
        ...
        public partial class ContactDataTable : global::System.Data.TypedTableBase<ContactRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public ContactRow AddContactRow(string name, string surname, string phone) {
...
namespace Contact_App.ContactDataSet1TableAdapters {
    ...
    public partial class ContactTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Contact] WHERE (([id] = @Original_id) AND ([name] = @Original_" +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Contact] ([name], [surname], [phone]) VALUES (@name, @surname," +
                " @phone);\r\nSELECT id, name, surname, phone FROM Contact WHERE (id = SCOPE_IDENTI" +
                "TY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Contact] SET [name] = @name, [surname] = @surname, [phone] = @phone WHERE (([id] = @Original_id) AND ([name] = @Original_name) AND ([surname] = @Original_surname) AND ([phone] = @Original_phone));
SELECT id, name, surname, phone FROM Contact WHERE (id = @id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id, name, surname, phone FROM dbo.Contact";
        ...
        public virtual int Fill(ContactDataSet1.ContactDataTable dataTable) {
        ...
        public virtual ContactDataSet1.ContactDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            ContactDataSet1.ContactDataTable dataTable = new ContactDataSet1.ContactDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(ContactDataSet1.ContactDataTable dataTable) {
